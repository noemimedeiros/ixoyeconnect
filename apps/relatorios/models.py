...
class RelatorioCulto(models.Model):
	...
	ministro = models.ForeignKey(Membro, on_delete=models.CASCADE, null=True, blank=True)
	total_dizimos = models.DecimalField(decimal_places=2, max_digits=12, default=0, verbose_name='Total Dízimos')
	total_ofertas = models.DecimalField(decimal_places=2, max_digits=12, default=0)
